...
// it counts how many products taken from each kind and the total qty to pay
import './App.css';
...
const App = () => {
  ...
  const add2Cart = async (prod, qty) => {
    ...
    if (temp) {
      ...
      const newItemInMyCart = { id: prod.id, desc: prod.desc, price: prod.price, qty: 1 }
